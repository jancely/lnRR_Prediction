...
- scipy == 1.11.2
       ...
       pip install scikit-learn==1.2.2 torch==2.0.1 pandas==2.0.1 numpy==1.23.5 scipy==1.11.2

### Script for replicating
    bash Prediction.sh 
...
![Global predicted cropland lnRR from our optimized model](https://github.com/jancely/lnRR_Prediction/Predict_lnRR.png)
